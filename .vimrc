...
set wrapscan
" Disable wrapping when, text goes over screen
set nowrap
...
set background=dark
" ':hi' show all current colors in vim
hi StatusLine ctermfg=white ctermbg=NONE
hi StatusLineNC ctermfg=black ctermbg=NONE
hi Normal ctermbg=NONE
hi Special ctermfg=cyan
hi LineNr ctermfg=222 ctermbg=NONE
...
hi vimTodo term=bold ctermbg=236 ctermfg=darkred
...
au FileType * hi LineNr ctermfg=white ctermbg=NONE
...
if filereadable(expand("~/.vim/autoload/plug.vim"))
  ...
  " Plugin documentation github.com/junegunn/vim-plug
